 ...
 */
public class RadioPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener,
  ...
  public interface RendererBuilder {
     ...
     *
     * @param player The player for which renderers are being built. {@link RadioPlayer#onRenderers}
     *     should be invoked once the renderers have been built. If building fails,
     *     {@link RadioPlayer#onRenderersError} should be invoked.
     */
    void buildRenderers(RadioPlayer player);
    /**
     * Cancels the current build operation, if there is one. Else does nothing.
     * <p>
     * A canceled build operation must not invoke {@link RadioPlayer#onRenderers} or
     * {@link RadioPlayer#onRenderersError} on the player, which may have been released.
     */
    void cancel();
  }
   ...
   *
   * @param renderers Renderers indexed by {@link RadioPlayer} TYPE_* constants. An individual
