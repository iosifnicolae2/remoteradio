...
public class HlsRendererBuilder implements RendererBuilder {
  ...
  private static final class AsyncRendererBuilder implements ManifestCallback<HlsPlaylist> {
    ...
    public AsyncRendererBuilder(Context context, String userAgent, String url, RadioPlayer player) {
      this.context = context;
      this.userAgent = userAgent;
      this.url = url;
      this.player = player;
    ...
    public void onSingleManifest(HlsPlaylist manifest) {
      ...
      HlsSampleSource sampleSource = new HlsSampleSource(chunkSource, loadControl,
          MAIN_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, RadioPlayer.TYPE_VIDEO);
      ...
      if (haveSubtitles) {
        ...
        HlsSampleSource textSampleSource = new HlsSampleSource(textChunkSource, loadControl,
            TEXT_BUFFER_SEGMENTS * BUFFER_SEGMENT_SIZE, mainHandler, player, RadioPlayer.TYPE_TEXT);
      ...
      renderers[RadioPlayer.TYPE_VIDEO] = videoRenderer;
      renderers[RadioPlayer.TYPE_AUDIO] = audioRenderer;
      renderers[RadioPlayer.TYPE_METADATA] = id3Renderer;
      renderers[RadioPlayer.TYPE_TEXT] = textRenderer;
